    ...
    <div className="min-h-screen bg-slate-950 text-slate-100">
      <div className="hero-shell">
        ...
        <main id="top">
          <section className="mx-auto max-w-7xl px-4 pb-16 pt-10 sm:px-6 lg:px-8 lg:pb-24 lg:pt-16">
            ...
            <div className="mt-10 grid gap-6 lg:mt-14 lg:grid-cols-[minmax(0,0.92fr)_minmax(0,1.08fr)] lg:items-start">
              ...
              <div className="order-1 lg:order-2">
                <div className="video-frame-shell">
                  <div className="video-frame">
                    <div className="video-topbar">
                      ...
                      <span className="text-[0.68rem] uppercase tracking-[0.38em] text-slate-500">
                        Terminal experience
                      </span>
                    </div>
                    ...
                    <div className="video-wrapper">
                      ...
                      <div className="pointer-events-none absolute inset-0 rounded-[1.3rem] ring-1 ring-white/8" />
                    </div>
                  </div>
                </div>
                ...
                <div
                  id="tecnologias"
                  className="mt-5 flex flex-wrap gap-2 rounded-[1.6rem] border border-white/10 bg-slate-900/65 p-4 shadow-[0_16px_50px_rgba(2,6,23,0.28)] backdrop-blur"
                >
                  {technologies.map((item) => (
                    <span
                      key={item}
                      className="rounded-full border border-white/10 bg-white/5 px-4 py-2 text-xs font-medium uppercase tracking-[0.28em] text-slate-300"
                    >
                      {item}
                    </span>
                  ))}
          ...
          <section id="servicos" className="border-y border-white/8 bg-slate-950/80">
            <div className="mx-auto grid max-w-7xl gap-6 px-4 py-14 sm:px-6 lg:grid-cols-3 lg:px-8">
              <article className="rounded-[1.8rem] border border-white/10 bg-white/5 p-6">
                ...
                <h3 className="mt-4 text-2xl font-semibold text-white">
                  Processos mais leves e escaláveis.
                </h3>
                <p className="mt-4 leading-7 text-slate-300">
                  Mapeamos rotinas, reduzimos fricção e desenhamos automações com impacto
                  real na operação.
                </p>
              </article>
              <article className="rounded-[1.8rem] border border-white/10 bg-white/5 p-6">
